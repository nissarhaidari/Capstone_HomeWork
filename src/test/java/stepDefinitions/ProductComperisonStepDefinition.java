...
import pageObjects.ProductComperisonObj;
import utilities.WebDriverUtility;

public class ProductComperisonStepDefinition extends Base {
	
	ProductComperisonObj Comparison = new ProductComperisonObj();
