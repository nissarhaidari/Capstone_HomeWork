...
import pageObjects.hpLaptopObj;
import utilities.WebDriverUtility;

public class HpLaptopStepDefinition extends Base{
	
	hpLaptopObj HpLap = new hpLaptopObj();
	
	@When("^User click on Desktops tab$")
	public void user_click_on_Desktops_tab() throws Throwable {
		HpLap.desktop();
		logger.info("User should click on desktop");
	...
	public void user_click_on_Show_all_desktops() throws Throwable {
		HpLap.showAllDesktop();
		logger.info("User should click on show all desktop");
		WebDriverUtility.wait(3000);
		WebDriverUtility.screenShot();
	}
